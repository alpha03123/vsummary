...
export function useWorkspaceController() {
  ...
  return {
    ...
    onSelectLegacyMigrationSource: settingsActions.onSelectLegacyMigrationSource,
    onInspectLegacyMigration: settingsActions.onInspectLegacyMigration,
    onCreateLegacyMigrationRun: settingsActions.onCreateLegacyMigrationRun,
    onStartLegacyMigrationRun: settingsActions.onStartLegacyMigrationRun,
    onLoadLegacyMigrationRun: settingsActions.onLoadLegacyMigrationRun,
    onLoadLatestLegacyMigrationRun: settingsActions.onLoadLatestLegacyMigrationRun,
    onCancelLegacyMigrationRun: settingsActions.onCancelLegacyMigrationRun,
