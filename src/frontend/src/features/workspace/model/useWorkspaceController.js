...
export function useWorkspaceController() {
  ...
  return {
    ...
    chaoxingChromium: state.chaoxingChromium,
    chaoxingChromiumLoading: state.chaoxingChromiumLoading,
    chaoxingChromiumDownloading: state.chaoxingChromiumDownloading,
    ...
    onDownloadChaoxingChromium: settingsActions.onDownloadChaoxingChromium,
