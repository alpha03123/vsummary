...
export function buildWorkspacePageModel(controller) {
  ...
  return {
    ...
    generation: {
      ...
      chaoxingChromium: controller.chaoxingChromium,
      chaoxingChromiumLoading: controller.chaoxingChromiumLoading,
      chaoxingChromiumDownloading: controller.chaoxingChromiumDownloading,
    ...
    actions: {
      ...
      downloadChaoxingChromium: controller.onDownloadChaoxingChromium,
