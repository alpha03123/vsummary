...
export function buildWorkspacePageModel(controller) {
  ...
  return {
    ...
    actions: {
      ...
      createBilibiliQrLoginSession: controller.onCreateBilibiliQrLoginSession,
      pollBilibiliQrLogin: controller.onPollBilibiliQrLogin,
      ...
      exportSeriesMarkdown: controller.onExportSeriesMarkdown,
