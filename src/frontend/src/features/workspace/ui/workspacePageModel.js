...
export function buildWorkspacePageModel(controller) {
  ...
  return {
    shell: {
      ...
      citationFocus: controller.citationFocus,
      player: {
    ...
    chat: {
      ...
      openCitationReference: controller.onOpenCitationReference,
      ...
      cancel: controller.onCancelChat,
    },
    generation: {
      ...
      seriesMindmapLoading: controller.seriesMindmapLoading,
      seriesOverviewLoading: controller.seriesOverviewLoading,
      generatingSeriesMindmap: controller.generatingSeriesMindmap,
      ...
      aiSummaryLoading: controller.aiSummaryLoading,
      generatingAiSummary: controller.generatingAiSummary,
      ...
      providerUsageRange: controller.state.providerUsageRange,
      providerUsage: controller.state.providerUsage,
      providerUsageLoading: controller.state.providerUsageLoading,
      providerUsageError: controller.state.providerUsageError,
    ...
    actions: {
      ...
      generateAiSummary: controller.onGenerateAiSummary,
      updateAiSummary: controller.onUpdateAiSummary,
      updateNote: controller.onUpdateNote,
      deleteNote: controller.onDeleteNote,
      deleteVideos: controller.onDeleteVideos,
      loadTranscriptMarkdown: controller.onLoadTranscriptMarkdown,
      loadSummaryMarkdown: controller.onLoadSummaryMarkdown,
      updateSummary: controller.onUpdateSummary,
      updateTranscript: controller.onUpdateTranscript,
      ...
      selectLegacyMigrationSource: controller.onSelectLegacyMigrationSource,
      inspectLegacyMigration: controller.onInspectLegacyMigration,
      createLegacyMigrationRun: controller.onCreateLegacyMigrationRun,
      startLegacyMigrationRun: controller.onStartLegacyMigrationRun,
      loadLegacyMigrationRun: controller.onLoadLegacyMigrationRun,
      loadLatestLegacyMigrationRun: controller.onLoadLatestLegacyMigrationRun,
      cancelLegacyMigrationRun: controller.onCancelLegacyMigrationRun,
      ...
      selectProviderModel: controller.onSelectProviderModel,
      discoverProviderModels: controller.onDiscoverProviderModels,
      saveApiKey: controller.onSaveApiKey,
      saveAsrSettings: controller.onSaveAsrSettings,
      revealAsrApiKey: controller.onRevealAsrApiKey,
      testAsrConnection: controller.onTestAsrConnection,
      ...
      initExternalCookie: controller.onInitExternalCookie,
      ...
      deleteSeriesByIds: controller.onDeleteSeriesByIds,
