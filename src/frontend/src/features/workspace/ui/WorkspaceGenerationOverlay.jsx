...
export function WorkspaceGenerationOverlay({ generationProgress, generationSnapshot }) {
  ...
  return (
    <motion.div
      ...
      className="absolute inset-0 z-50 flex items-center justify-center bg-white/40 backdrop-blur-[4px] pointer-events-auto dark:bg-[#0a0a0a]/50"
    >
      <motion.div
      ...
      >
        ...
        <div className="w-full">
          ...
          <p className="mb-3 text-xs font-bold text-[#0b6bff]">
