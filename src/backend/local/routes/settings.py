...
def _to_workspace_settings_response(settings) -> WorkspaceSettingsResponse:
    ...
    return WorkspaceSettingsResponse(
        ...
        chapter_visual_mode=settings.chapter_visual_mode,
        max_visual_input_images=settings.max_visual_input_images,
        note_visual_mode=settings.note_visual_mode,
        ai_summary_multimodal_enabled=settings.ai_summary_multimodal_enabled,
        mindmap_visual_input=settings.mindmap_visual_input,
        cards_visual_input=settings.cards_visual_input,
        note_max_images=settings.note_max_images,
        auto_generate_artifacts=list(settings.auto_generate_artifacts),
...
async def update_workspace_settings(
    ...
    try:
        settings = container.settings_service.update_workspace_settings(
            ...
            chapter_visual_mode=request.chapter_visual_mode,
            max_visual_input_images=request.max_visual_input_images,
            note_visual_mode=request.note_visual_mode,
            ai_summary_multimodal_enabled=request.ai_summary_multimodal_enabled,
            mindmap_visual_input=request.mindmap_visual_input,
            cards_visual_input=request.cards_visual_input,
            note_max_images=request.note_max_images,
