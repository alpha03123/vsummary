...
async def init_bilibili_cookie(container: ApiContainerDep) -> CookieStatusResponse:
    try:
...
async def init_external_cookie(provider: str, container: ApiContainerDep) -> CookieStatusResponse:
