...
from backend.video_summary.infrastructure.config.settings import (
    ...
    replace_downstream_visual_settings,
...
class SettingsServicePort(Protocol):
    ...
    def update_workspace_settings(
        ...
        *,
        ...
        mindmap_visual_input: str = "none",
        cards_visual_input: str = "none",
    ...
    def update_workspace_settings(
        ...
        *,
        ...
        for field_name, value in (
            ...
            if value not in VALID_VISUAL_INPUTS:
                raise SettingsValidationError(f"{field_name} 必须是 none、evidence 或 frames。")
        if note_max_images <= 0:
            raise SettingsValidationError("note_max_images 必须是正整数。")
        ...
        with self._settings_lock:
            ...
            next_settings = replace_downstream_visual_settings(
                ...
                note_image_min_gap_seconds=current_settings.generation.note_image_min_gap_seconds,
            )
