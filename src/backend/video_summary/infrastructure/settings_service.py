...
class SettingsService:
    ...
    def get_workspace_settings(self) -> WorkspaceSettings:
        ...
        return WorkspaceSettings(
            ...
            series_markdown_export_path=settings.workspace_ui.series_markdown_export_path,
        )
    ...
    def update_workspace_settings(
        ...
        *,
        ...
        with self._settings_lock:
            ...
            next_settings = replace_workspace_ui_settings(
                ...
                WorkspaceUiSettings(
                    ...
                    series_markdown_export_path=series_markdown_export_path.strip(),
                ),
            )
        ...
        return WorkspaceSettings(
            ...
            series_markdown_export_path=next_settings.workspace_ui.series_markdown_export_path,
        )
