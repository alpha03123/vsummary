...
from backend.video_summary.workspace.models import VideoMindmapDTO
from backend.video_summary.summary_generation.service_ports import VideoMindmapGenerator
