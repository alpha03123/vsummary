...
from backend.video_summary.adapters.media.faster_whisper_transcriber import FasterWhisperTranscriber
...
from backend.video_summary.configuration.settings import AppSettings
from backend.video_summary.summary_generation.ports import Summarizer, Transcriber
