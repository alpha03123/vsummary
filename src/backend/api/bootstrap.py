...
class ApiContainer:
    ...
    create_agent_series: CreateAgentSeries
    add_agent_series_videos: AddAgentSeriesVideos
    bilibili_cookie_initializer: BiliNoteBilibiliCookieInitializer
    bilibili_cookie_config_manager: BiliNoteCookieConfigManager
    bilibili_qr_login_service: BiliNoteQrLoginService
...
def build_api_container(
    ...
    bilibili_cookie_initializer = BiliNoteBilibiliCookieInitializer(root_dir=root_dir)
    bilibili_cookie_config_manager = BiliNoteCookieConfigManager(root_dir / "config" / "downloader.json")
    bilibili_qr_login_service = BiliNoteQrLoginService(cookie_initializer=bilibili_cookie_initializer)
    ...
    return ApiContainer(
        ...
        create_agent_series=CreateAgentSeries(workspace, workspace_index_invalidator),
        add_agent_series_videos=AddAgentSeriesVideos(workspace, bilibili_resolver, workspace_index_invalidator),
        bilibili_cookie_initializer=bilibili_cookie_initializer,
        bilibili_cookie_config_manager=bilibili_cookie_config_manager,
        bilibili_qr_login_service=bilibili_qr_login_service,
