...
from backend.video_summary.summary_generation.usecases.generate_summary import GenerateCancelledError, GenerateVideoSummary
...
class FakeMediaProcessor:
    ...
    def extract_audio(self, video_path: Path, audio_path: Path, cancellation=None) -> Path:
        if cancellation is not None:
            ...
            proc.wait = fake_wait
            from backend.video_summary.summary_generation.cancellation import ProcessHandle
