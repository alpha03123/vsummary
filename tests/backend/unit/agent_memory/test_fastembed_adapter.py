...
from backend.video_summary.adapters.rag.agent_memory.fastembed_adapter import FastEmbedEmbedding


class FastEmbedEmbeddingTests(unittest.TestCase):
    def test_uses_fastembed_for_text_and_query_embeddings(self) -> None:
        with patch(
            "backend.video_summary.adapters.rag.agent_memory.fastembed_adapter._load_text_embedding_cls",
    ...
    def test_gpu_device_uses_cuda_provider_without_cpu_fallback(self) -> None:
        ...
        with (
            ...
            patch("backend.video_summary.adapters.rag.agent_memory.fastembed_adapter._prepare_cuda_runtime") as prepare,
        ):
    ...
    def test_gpu_device_rejects_cpu_fallback(self) -> None:
        ...
        with (
            ...
            patch("backend.video_summary.adapters.rag.agent_memory.fastembed_adapter._prepare_cuda_runtime"),
        ):
